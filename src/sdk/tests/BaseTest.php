...
use \plainview\sdk_eightb_sold_alerts\base;

class BaseTest
	extends \plainview\sdk_eightb_sold_alerts\tests\TestCase
{
	...
	**/
	public function test_current_url()
	{
		...
		$result = \plainview\sdk_eightb_sold_alerts\base::current_url( $SERVER );
