...
namespace plainview\sdk_eightb_sold_alerts\wordpress;

class base
	extends \plainview\sdk_eightb_sold_alerts\base
{
	/**
	...
	**/
	public function __construct( $__FILE__ = null )
	{
		...
		$this->submenu_pages = new \plainview\sdk_eightb_sold_alerts\collections\collection;
...
**/
	...
	**/
	...
	{
		$form = new \plainview\sdk_eightb_sold_alerts\wordpress\form2\form( $this );
		return $form;
	}

	/**
		@brief		Backwards compatibility alias for form.
		@return		\\plainview\\sdk_eightb_sold_alerts\\form2\\form		A new form object.
		@since		20130509
	**/
	...
	**/
	...
	{
		$tabs = new \plainview\sdk_eightb_sold_alerts\wordpress\tabs\Nav_Tabs( $this );
		return $tabs;
	}
	...
	**/
	...
	{
		$tabs = new \plainview\sdk_eightb_sold_alerts\wordpress\tabs\Subsubsub_Tabs( $this );
		return $tabs;
	}
	...
	**/
	...
	/**
		...
		@return		object		A new \\plainview\\sdk_eightb_sold_alerts\\wordpress\\table object.
		@since		20130416
	**/
	public function table()
	{
		$table = new \plainview\sdk_eightb_sold_alerts\wordpress\table\table( $this );
